...
<head>
	...
	<div class="container grid-sm s-content header">
		<div class="column col-12">
			...
			<p class="description">这里记录了 <a href="#" target="_blank">@男孩</a> 和 <a href="#" target="_blank">@女孩</a> 相爱的100件事。<br>相信我们还会留下更多美好的回忆，谢谢大家的 <a href="<?php $this->options->message() ?>">祝福</a> ！</p>
		</div>
	</div>