...
<div class="container grid-sm s-content footer">
    <div class="column col-12">
        <p>内核：<a href="http://typecho.org/" target="blank">Typecho</a>，模板：<a href="https://www.xujianhua.com/18.html" target="blank">XJH</a>，<a href="<?php $this->options->links(); ?>">生存手册</a>。<a class="top" href="#">返回顶部</a></p>
    </div>
</div>
<script>
